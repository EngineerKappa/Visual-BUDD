...
void sceneLogic()
{
	...
	{
	case 1: loadBackground(bg1); portrait_preload(0,ERIS,NORMAL); VN_TextboxOpen();break;
	case 2: portrait_retrieve(ERIS,NORMAL);break;
	case 3: VN_OpenMenu();  break;
...
void scene_test_1()
{
	...
	case 13: VDP_setHilightShadow(0);VN_Text(RHEA, "...Wait, who are you?"); break;
